...
/****** Object:  StoredProcedure [Inv].[spGetAllProductOpenNColStock]    Script Date: 5/31/2017 12:16:45 PM ******/
SET ANSI_NULLS ON
GO
...
Declare @tblResult table(PID int,PName nvarchar(50),OpeningStock decimal(19,5),ClosingStock decimal(19,5))
...
select @productID,EngName,@ProductOpeningStock,@ProductClosingStock from inv.tblProduct where ProductID=@productID
