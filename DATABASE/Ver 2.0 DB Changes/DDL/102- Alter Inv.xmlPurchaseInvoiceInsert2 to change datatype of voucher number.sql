...
alter PROC [Inv].[xmlPurchaseInvoiceInsert2](@specific xml,@common xml,@lastReturn nvarchar(20) output)
AS  
BEGIN
    ...
    --         DEALLOCATE P_CURSOR
           ...
           --INSERT DATA IN PURCHASE INVOICE MASTER BASE TABLE
             ...
             SpecialDiscount,TotalQty,CustomDuty,Freight,PartyBillNumber,Field1,Field2,Field3,Field4,Field5
              ...
              WITH(
              SeriesID INT,PurchaseLedgerID INT,CashPartyLedgerID INT,ProjectID INT,DepotID INT,OrderNo VARCHAR(20), Voucher_No nvarchar(100), PurchaseInvoice_Date DATETIME,
