...
{
    public partial class frmDoctorFaculty : Form
    {
        public frmDoctorFaculty()
        {
            InitializeComponent();
        }
        ...
        private void frmDoctorFaculties_Load(object sender, EventArgs e)
        {
            try
            {
                dt = Hos.GetFaculty();
        ...
        private void fillForm(int ID)
        {
            ...
            try
            {
                DataTable dt = Hos.GetFaculty(ID);
        ...
        private void btnsave_Click(object sender, EventArgs e)
        {
             try
            {
                ...
                {
                    case EntryMode.NEW:
                        int i = Hos.CreateFaculty(txtCode.Text.Trim(), txtName.Text, txtRemarks.Text);
                        if (i == -100)
                        {
                        ...
                        break;
                    case EntryMode.EDIT:
                        int j = Hos.UpdateFaculty(Convert.ToInt32(txtFacultyID.Text), txtCode.Text.Trim(), txtName.Text, txtRemarks.Text);
                        if (j == -100)
                        {
                            Global.Msg("The code already exists.");
                            return;
                ...
                ClearForm();
                frmDoctorFaculties_Load(sender, e);
                ChangeState(EntryMode.NORMAL);
            }
            catch (Exception ex)
            {
