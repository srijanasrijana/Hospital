...
namespace HRM.View
{
    public partial class frmEmpLevel : Form
    {
        public frmEmpLevel()
        {
            InitializeComponent();
        ...
        private void fillForm(int ID)
        {
            ...
            try
            {
                DataTable dt = BusinessLogic.Hrm.GetEmpLevelByID(ID);
        ...
        private void frmEmpLevel_Load(object sender, EventArgs e)
        {
            dt = BusinessLogic.Hrm.GetEmpLevel();
        ...
        private void btnsave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (UserValidation.validDecimal(txtLvlBasicSal.Text))
                {
                    ...
                    {
                        case EntryMode.NEW:
                            DataTable dt = BusinessLogic.Hrm.CreateLevel(txtLvlCode.Text.Trim(), txtLvlName.Text.Trim(), txtLvlBasicSal.Text == ""?0: Convert.ToDecimal(txtLvlBasicSal.Text),txtGradeNo.Text == ""?0:Convert.ToInt32(txtGradeNo.Text),txtGradeAmt.Text == ""?0:Convert.ToDecimal(txtGradeAmt.Text), txtRemarks.Text);
                            MessageBox.Show("Record saved");
                            break;
                        case EntryMode.EDIT:
                            DataTable dt1 = BusinessLogic.Hrm.UpdateLevel(Convert.ToInt32(txtLvlID.Text), txtLvlCode.Text.Trim(), txtLvlName.Text.Trim(), txtLvlBasicSal.Text == "" ? 0 : Convert.ToDecimal(txtLvlBasicSal.Text), txtGradeNo.Text == "" ? 0 : Convert.ToInt32(txtGradeNo.Text), txtGradeAmt.Text == "" ? 0 : Convert.ToDecimal(txtGradeAmt.Text), txtRemarks.Text);
                            MessageBox.Show("Record saved");
                            break;
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    int i = BusinessLogic.Hrm.DeleteLevel(lvlId);
