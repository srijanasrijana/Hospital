...
namespace Inventory
{
    public partial class frmPurchaseReturnSettings : Form, IfrmSelectAccClassID, IfrmDateConverter
    {
        ReportPreference m_ReportPreference;
        ArrayList AccClassID = new ArrayList();
        private string Prefix = "";
        private bool IsFromDate = false;
        public frmPurchaseReturnSettings()
        {
            InitializeComponent();
        }
        ...
        private void btnShow_Click(object sender, EventArgs e)
        {
            ...
            if (m_PRS.PartyID > 0)
            {
                frmPurchaseReturnRegisterPartyWise frms = new frmPurchaseReturnRegisterPartyWise(m_PRS);
                frms.Show();
            }
            else
            {
                frmPurchaseReturnRegister frm = new frmPurchaseReturnRegister(m_PRS);
                frm.Show();
            }

         //  frmPurchaseRtnRegister frm = new frmPurchaseRtnRegister(m_PRS);
            //frm.Show();
        }
        ...
        private void frmPurchaseReturnSettings_Load(object sender, EventArgs e)
        {
            LoadMonths(); 
            ...
            DataTable dtrpt = m_ReportPreference.GetPreferenceCount(checkuserid, "PURCHASE_RETURN");
        ...
        private void ChangeReportPreferences()
        {
            ...
            DataTable dt = m_ReportPreference.GetPreferenceInfo(UserID, "PURCHASE_RETURN");

            //For Accounting Class
            Code = "PRR_ACCOUNTING_CLASS";
