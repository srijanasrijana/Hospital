...
{
    public partial class frmPurchaseRegisterPatyWise : Form
    {
        public frmPurchaseRegisterPatyWise()
        {
            InitializeComponent();
        }
        public frmPurchaseRegisterPatyWise(InventoryBookSettings PR)
        {
            InitializeComponent();
      ...
      private void frmPurchaseRegisterPatyWise_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void DisplayInventoryPurchaseRegister(bool IsCrystalReport)
        {
            try
            {
                ...
                DataTable dtInventoryDayBookInfo = InventoryBook.GetInventoryBook(m_PR.partyGroupID, m_PR.PartyID, m_PR.ProductGroupID, m_PR.ProductID,
                    m_PR.DepotID, m_PR.ProjectID, m_PR.FromDate, m_PR.ToDate, InvenotryBookType.PurchaseRegister,
                    AccClassIDsXMLString, ProjectIDsXMLString, ref OpeningQty);
//Date format in nepali or english according to setting
                              ...
                              DevAge.ComponentModel.IBoundList bindList)
        {
            ...
            gridColumn = dgPurchaseRegister.Columns.Add("InBoundQty", "PurchaseQty", new SourceGrid.Cells.DataGrid.Cell());
        ...
        private void btnRefresh_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                //Load all over again
                frmPurchaseRegisterPatyWise_Load(sender, e);
                this.Cursor = Cursors.Default;
