...
{
    public partial class frmSalesReturnRegisterPartyWise : Form
    {
        public frmSalesReturnRegisterPartyWise(InventoryBookSettings SRR)
        {
            InitializeComponent();
            m_SRR = new InventoryBookSettings();
            m_SRR = SRR;
        }
        public frmSalesReturnRegisterPartyWise()
        {
            InitializeComponent();
        }
        ...
        private void frmSalesReturnRegisterPartyWise_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void DisplayBannar()
        {
          ...
          //If it has a date range
            ...
            if (m_SRR.PartyID > 0)
            {
                DataTable dtLedgerInfo = Ledger.GetLedgerInfo(Convert.ToInt32(m_SRR.PartyID), LangMgr.DefaultLanguage);
        ...
        private void DisplayInventorySalesReturnRegister(bool IsCrystalReport)
        {
            try
            {
                ...
                lblOutBoundQty.Text = "OuBound Qty=" + TotalOutBound.ToString();
        ...
        private void btnRefresh_Click(object sender, EventArgs e)
        {
            ...
            //Load all over again
            frmSalesReturnRegisterPartyWise_Load(sender, e);
