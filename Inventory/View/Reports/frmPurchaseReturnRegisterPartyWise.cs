...
{
    public partial class frmPurchaseReturnRegisterPartyWise : Form
    {
        public frmPurchaseReturnRegisterPartyWise(InventoryBookSettings PR)
        {
            InitializeComponent();
            m_PR = new InventoryBookSettings();
            m_PR = PR;
        }
        public frmPurchaseReturnRegisterPartyWise()
        {
            InitializeComponent();
        }
        ...
        private void frmPurchaseReturnRegisterPartyWise_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void DisplayBannar()
        {
            ...
            if (m_PR.PartyID > 0)
            {
                DataTable dtLedgerInfo = Ledger.GetLedgerInfo(Convert.ToInt32(m_PR.PartyID), LangMgr.DefaultLanguage);
          ...
          try
            {
               ...
               DataTable dtInventoryDayBookInfo = InventoryBook.GetInventoryBook(m_PR.partyGroupID, m_PR.PartyID, m_PR.ProductGroupID, m_PR.ProductID,
                    m_PR.DepotID, m_PR.ProjectID, m_PR.FromDate, m_PR.ToDate, InvenotryBookType.PurchaseReturnRegister,
                ...
                lblOutBoundQty.Text = "PurchaseRtn Qty= " + TotalOutBound.ToString();
                               ...
                               DevAge.ComponentModel.IBoundList bindList)
        {
            ...
            gridColumn = dgPurchaseRegister.Columns.Add("InBoundQty", "Inbound Qty", new SourceGrid.Cells.DataGrid.Cell());
            gridColumn.DataCell.View = viewNumeric;
            gridColumn.Visible = false;
      
            gridColumn = dgPurchaseRegister.Columns.Add("OutBoundQty", "PurchaseReturn Qty", new SourceGrid.Cells.DataGrid.Cell());
            gridColumn.DataCell.View = viewNumeric;
            gridColumn.DataCell.AddController(dblClick);
            gridColumn.DataCell.AddController(gridKeyDown);
            gridColumn.Width = 80;
        ...
        private void PrintPreviewCR(PrintType myPrintType)
        {
            ...
            pdvProductName.Value = "Purchase Return Register Product";
            pvCollection.Clear();
        ...
        private void btnRefresh_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                //Load all over again
                frmPurchaseReturnRegisterPartyWise_Load(sender, e);
                this.Cursor = Cursors.Default;
