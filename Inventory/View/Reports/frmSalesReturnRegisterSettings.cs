...
namespace Inventory
{
    public partial class frmSalesReturnRegisterSettings : Form, IfrmSelectAccClassID, IfrmDateConverter
    {
        ReportPreference m_ReportPreference;
        ArrayList AccClassID = new ArrayList();
        private string Prefix = "";
        private bool IsFromDate = false;
        public frmSalesReturnRegisterSettings()
        {
            InitializeComponent();
        }
        ...
        private void frmSalesReturnRegisterSettings_Load(object sender, EventArgs e)
        {
            LoadMonths();
            ...
            DataTable dtrpt = m_ReportPreference.GetPreferenceCount(checkuserid, "SALES_RETURN");
        ...
        {
            InventoryBookSettings m_SRS = new InventoryBookSettings();
            ...
            if (m_SRS.PartyID > 0)
            {
                frmSalesReturnRegisterPartyWise frms = new frmSalesReturnRegisterPartyWise(m_SRS);
                frms.Show();
            }
            else
            {
                frmSalesReturnRegister frm = new frmSalesReturnRegister(m_SRS);
                frm.Show();
            }
        }
        ...
        private void ChangeReportPreferences()
        {
            ...
            DataTable dt = m_ReportPreference.GetPreferenceInfo(UserID, "SALES_RETURN");

            //For Accounting Class  
            Code = "SRR_ACCOUNTING_CLASS";
