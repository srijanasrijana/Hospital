...
namespace Accounts
{
    public partial class frmProfitLossAcc : Form
    {
        ...
        private Accounts.Model.dsProfitandLoss dsProfitLoss = new Model.dsProfitandLoss();
        ...
        public frmProfitLossAcc(ProfitLossAccSettings ProfitLoss, IMDIMainForm frm)//Constructor having class as argumenet
        {
            M_MDIMain = frm;
        ...
        private void CreateColforTemp()
        {
            ...
            dtTemp.Columns.Add("ES.No", typeof(string));
            dtTemp.Columns.Add("EAccount", typeof(string));
            dtTemp.Columns.Add("EAmount", typeof(string));
            dtTemp.Columns.Add("EAccountID", typeof(string));
            dtTemp.Columns.Add("EType", typeof(string));
        ...
        private void FillGridWithData()
        {
            ...
            try
            {
                grdProfitLossAcc.Visible = false;
                dgProfitLossAcc.Visible = true;
                dgProfitLossAcc.SelectionMode = SourceGrid.GridSelectionMode.Cell;
                dgProfitLossAcc.Selection.EnableMultiSelection = false;
                ...
                view.AllowNew = false;
                dgProfitLossAcc.FixedRows = 1;

                // dgProfitLossAcc.hea
                DevAge.ComponentModel.IBoundList bd = new DevAge.ComponentModel.BoundDataView(view);
                CreateDataGridColumns(dgProfitLossAcc.Columns, bd);
                dgProfitLossAcc.DataSource = bd;
                dgProfitLossAcc.Width = dgProfitLossAcc.Width - 5;
                dgProfitLossAcc.Width = this.Width - 25;
        ...
        private void CreateDataGridColumns(SourceGrid.DataGridColumns columns, DevAge.ComponentModel.IBoundList boundList)
        {
            ...
            con_LdgView.EvaluateFunction = delegate(SourceGrid.DataGridColumn column, int gridRow, object itemRow)
            {
                try
                {
                    ...
                    if (i <= 5)
                    {
                        return (string)row["ES.No"] != "-";
                    }
                    else
                    {
                        return (string)row["ES.No_2"] != "-";
                    }
                }
                catch (Exception ex)
                {
            ...
            val.EvaluateFunction = delegate(SourceGrid.DataGridColumn column, int gridRow, object itemRow)
            {
                ...
                DataRowView row = (DataRowView)itemRow;
                if (i <= 5)
                    if ((string)row["EAccount"] == " " || (string)row["ES.No"] == "H")
                        return true;
                    else
                        return false;

                else
                    return (string)row["EAccount_2"] == " ";
            };
            ...
            gridColumn = dgProfitLossAcc.Columns.Add("RowID", "RowID", new SourceGrid.Cells.DataGrid.Cell());
            gridColumn.HeaderCell.View = viewColumnHeader;
            gridColumn.Width = 50;
            gridColumn.Visible = false;

            gridColumn = dgProfitLossAcc.Columns.Add("ES.No", "S.No", new SourceGrid.Cells.DataGrid.Cell());
            gridColumn.HeaderCell.View = viewColumnHeader;
            gridColumn.Width = 50;
            gridColumn.Visible = false;

            gridColumn = dgProfitLossAcc.Columns.Add("EAccount", "Account Name", new SourceGrid.Cells.DataGrid.Cell());
            gridColumn.HeaderCell.View = viewColumnHeader;
            ...
            gridColumn = dgProfitLossAcc.Columns.Add("EAmount", "Amount", new SourceGrid.Cells.DataGrid.Cell());
            gridColumn.HeaderCell.View = viewColumnHeader;
            gridColumn.DataCell.AddController(dblClick);
            gridColumn.Conditions.Add(con_HeadViewforVFormat);
            ...
            gridColumn = dgProfitLossAcc.Columns.Add("EAccountID", "AccountID", new SourceGrid.Cells.DataGrid.Cell());
            gridColumn.HeaderCell.View = viewColumnHeader;
            gridColumn.Width = 50;
            gridColumn.Visible = false;

            gridColumn = dgProfitLossAcc.Columns.Add("EType", "Type", new SourceGrid.Cells.DataGrid.Cell());
            gridColumn.HeaderCell.View = viewColumnHeader;
            gridColumn.Width = 50;
            gridColumn.Visible = false;

            gridColumn = dgProfitLossAcc.Columns.Add("CategoryID", "CategoryID", new SourceGrid.Cells.DataGrid.Cell());
            gridColumn.HeaderCell.View = viewColumnHeader;
            gridColumn.Width = 50;
            gridColumn.Visible = false;
            ...
            {
                gridColumn = dgProfitLossAcc.Columns.Add("RowID_2", "RowID", new SourceGrid.Cells.DataGrid.Cell());
                gridColumn.HeaderCell.View = viewColumnHeader;
                gridColumn.Width = 50;
                gridColumn.Visible = false;

                gridColumn = dgProfitLossAcc.Columns.Add("ES.No_2", "S.No", new SourceGrid.Cells.DataGrid.Cell());
                gridColumn.HeaderCell.View = viewColumnHeader;
                gridColumn.Width = 50;
                gridColumn.Visible = false;

                gridColumn = dgProfitLossAcc.Columns.Add("EAccount_2", "Account Name", new SourceGrid.Cells.DataGrid.Cell());
                gridColumn.HeaderCell.View = viewColumnHeader;
                gridColumn.DataCell.AddController(dblClick);
                ...
                gridColumn = dgProfitLossAcc.Columns.Add("EAmount_2", "Amount", new SourceGrid.Cells.DataGrid.Cell());
                gridColumn.HeaderCell.View = viewColumnHeader;
                gridColumn.DataCell.AddController(dblClick);
                gridColumn.Conditions.Add(con_secondHead);
                gridColumn.Conditions.Add(con_amountLdg);
                ...
                gridColumn = dgProfitLossAcc.Columns.Add("EAccountID_2", "AccountID", new SourceGrid.Cells.DataGrid.Cell());
                gridColumn.HeaderCell.View = viewColumnHeader;
                gridColumn.Width = 50;
                gridColumn.Visible = false;

                gridColumn = dgProfitLossAcc.Columns.Add("EType_2", "Type", new SourceGrid.Cells.DataGrid.Cell());
                gridColumn.HeaderCell.View = viewColumnHeader;
                gridColumn.Width = 50;
                gridColumn.Visible = false;
            ...
            dgProfitLossAcc.AutoStretchColumnsToFitWidth = true;
        }
        ...
        private void CreateData()
        {
            ...
            try
            {
                //  CreateColforDtIncome();
                decimal expTotal = 0;
                decimal incomeTotal = 0;
                ////decimal openingStock = 0;
                ////decimal closingStock = 0;
                //git opening and closing stock of products
              dummy=   Product.GetAllProductOpnNCloStock("<AccClassIDSettings><AccClassID>1</AccClassID></AccClassIDSettings>", "<ProjectIDSettings><ProjectID>1</ProjectID></ProjectIDSettings>",null, m_ProfitLoss.ToDate,0,0, ref OpeningStock,ref ClosingStock);
                ...
                // .openingStock.dtTemp.Rows.Add(rowID, "-", "Opening Stock", openingStock.ToString(Misc.FormatNumber(Global.Comma_Separated, Global.DecimalPlaces)), "0", dr["AccountType"].ToString(), "1");
                 dtData = Ledger.GetAllGroupNLedgerBal("<AccClassIDSettings><AccClassID>1</AccClassID></AccClassIDSettings>", "<ProjectIDSettings><ProjectID>1</ProjectID></ProjectIDSettings>", null, m_ProfitLoss.ToDate, 0, null);
                ...
                {
                    //for expenditure account get all of its child group and ledger
                    if (Convert.ToInt32(dr["ParentGroupID"]) == 0 && Convert.ToInt32(dr["AccountID"]) == 4)
                    {
                        rowID = 1;
                        CreateColforTemp();
                        ...
                        dtTemp.Rows.Add(rowID, "-", dr["AccountName"].ToString(), expTotal.ToString(Misc.FormatNumber(Global.Comma_Separated, Global.DecimalPlaces)), dr["AccountID"].ToString(), dr["AccountType"].ToString(), "1");
                        rowID++;
                        //format all child in tree structure
                        FormatDataInTable(dr, 1, 0);
                        if (OpeningStock == 0)
                        {
                            if (m_ProfitLoss.ShowZeroBalance)
                                dtTemp.Rows.Add(rowID.ToString(), "-", "Opening Stock", 0.ToString(Misc.FormatNumber(Global.Comma_Separated, Global.DecimalPlaces)), " ", "GROUP", "1");
                        }
                        else
                        {
                            dtTemp.Rows.Add(rowID.ToString(), "-", "Opening Stock", OpeningStock.ToString(Misc.FormatNumber(Global.Comma_Separated, Global.DecimalPlaces)), " ", "GROUP", "1");
                        }
                        rowID++;
                        //fill dtexpenditure with formated expenditure data
                        dtExpenditure = dtTemp.Copy();
                        dtTemp.Clear();
                    }
                    //for income account get all of its child and group and ledger
                    if (Convert.ToInt32(dr["ParentGroupID"]) == 0 && Convert.ToInt32(dr["AccountID"]) == 3)
                    {
                        rowID = 1;
                        CreateColforTemp();
                        rowID++;
                        ...
                        dtTemp.Rows.Add(rowID.ToString(), "-", dr["AccountName"].ToString(), incomeTotal.ToString(Misc.FormatNumber(Global.Comma_Separated, Global.DecimalPlaces)), dr["AccountID"].ToString(), dr["AccountType"].ToString(), "2");
                        rowID++;
                        //format all child in tree structure
                        ...
                        dtIncome = dtTemp.Copy();
                        dtTemp.Clear();
                    }
                }

                //calculate net profit or loss
                if ((incomeTotal + ClosingStock) >= (expTotal + OpeningStock))
                {
                    dtExpenditure.Rows.Add(" ", "-", "Net Profit", Convert.ToDecimal(((incomeTotal + ClosingStock) - (expTotal + OpeningStock)).ToString(Misc.FormatNumber(Global.Comma_Separated, Global.DecimalPlaces))), " ", "GROUP", "1");
                    Total = (incomeTotal + ClosingStock);
                }
                else
                {
                    dtIncome.Rows.Add(" ", "-", "Net Loss", Convert.ToDecimal(((expTotal + OpeningStock) - (incomeTotal + ClosingStock)).ToString(Misc.FormatNumber(Global.Comma_Separated, Global.DecimalPlaces))), " ", "GROUP", "2");
                    Total = OpeningStock + expTotal;
                }

                //merge expenditure and income data into a single table for display
                dtfinal = dtExpenditure.Clone();//get table structure from dt expenditure which is as similar as dtincome
                if (m_ProfitLoss.DispFormat == ProfitLossAccSettings.DisplayFormat.TFormat)
                {
                    //for T-Format make sure both tables number of row is equal by adding empty rows if neccessary
                    int exlength = dtExpenditure.Rows.Count;
                    int inlength = dtIncome.Rows.Count;
                    if (exlength > inlength)
                    {
                        for (int i = inlength; i < exlength; i++)
                        {
                            dtIncome.Rows.Add(" ", " ", " ", " ", " ", " ", " ");
                        }
                    }
                    ...
                    {
                        for (int i = exlength; i < inlength; i++)
                        {
                            dtExpenditure.Rows.Add(" ", " ", " ", " ", " ", " ", " ");
                        }
                    }
                    //add total row at last of both tables to display total value
                    dtIncome.Rows.Add(" ", "-", "Total", Total.ToString(Misc.FormatNumber(Global.Comma_Separated, Global.DecimalPlaces)), " ", "TOTAL", "2");
                    dtExpenditure.Rows.Add(" ", "-", "Total", Total.ToString(Misc.FormatNumber(Global.Comma_Separated, Global.DecimalPlaces)), " ", "TOTAL", "1");

                    //finally merge data from dtexpenditure and dtincome into dtfinal
                    foreach (DataColumn col in dtIncome.Columns)
                    {
                    ...
                    var mergedRows = dtExpenditure.AsEnumerable().Zip(dtIncome.AsEnumerable(),
                ...
                else
                {
                    ...
                    dtfinal.Rows.Add(" ", "H", "EXPENDITURE", " ", " ", " ", " ");
                    dtfinal.Merge(dtExpenditure);
                    //add row for income in grid
                    dtfinal.Rows.Add(" ", "H", "INCOME", " ", " ", " ", " ");
                    dtfinal.Merge(dtIncome);//this merge wil simply append income data to the dtfinal with no change in table structure
                }
            }
            catch (Exception ex)
            {
        ...
        private void FormatDataInTable(DataRow dr, int level, int flag)//level is for adding space infront of name and flag is for deciding wheather it is debit or credit balance to calculate
        {
            ...
            foreach (DataRow childRow in ChildRows)
            {
                ...
                if (childRow["AccountType"].ToString() == "GROUP")
                {
                    ...
                    // dsProfitLoss.Tables["tblProfitLoss"].Rows.Add(rowID, space + childRow["AccountName"].ToString(), Convert.ToDouble(balance), 1, "Group");
                    else
                    ...
                    //  dsProfitLoss.Tables["tblProfitLoss"].Rows.Add(rowID, space + childRow["AccountName"].ToString(), Convert.ToDouble(balance), 2, "Group");
                ...
                else if (childRow["AccountType"].ToString() == "LEDGER")//if ledger
                {
                    if (m_ProfitLoss.Detail)
                    {
                        ...
                        //  dsProfitLoss.Tables["tblProfitLoss"].Rows.Add(rowID, space + childRow["AccountName"].ToString(), Convert.ToDouble(balance), 1, "Ledger");
                        else
                        ...
                        // dsProfitLoss.Tables["tblProfitLoss"].Rows.Add(rowID, space + childRow["AccountName"].ToString(), Convert.ToDouble(balance), 2, "Ledger");
        ...
        private void frmProfitLossAcc_Load(object sender, EventArgs e)
        {
            ...
            dblClick.KeyUp += new KeyEventHandler(dgProfitNloss_KeyUp);
            ...
            FillGridWithData();
            dgProfitLossAcc.EnableSort = false;
        ...
        private void DisplayBannar()
        {
            ...
            if (m_CmpDtl.FYFrom != null)
                lblAllSettings.Text = "Fiscal Year: " + Date.ToSystem(Convert.ToDateTime(m_CmpDtl.FYFrom)).ToString();

            if (m_ProfitLoss.ProjectID != 0)
            {
                lblProjectName.Text = " Project: All Project ";
        ...
        private void dgProfitNloss_KeyUp(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
                grdProfitLoss_DoubleClick(sender, null);
        }

        private void grdProfitLoss_DoubleClick(object sender, EventArgs e)
        {

            int curColumn = dgProfitLossAcc.Selection.GetSelectionRegion().GetColumnsIndex()[0];
            int curRow = dgProfitLossAcc.Selection.GetSelectionRegion().GetRowsIndex()[0];
            string Type = " ";
            string ID = " ";
            if (curColumn <= 6)
            {
                SourceGrid.CellContext cellType = new SourceGrid.CellContext(dgProfitLossAcc, new SourceGrid.Position(curRow, 5));
                SourceGrid.CellContext cellTypeID = new SourceGrid.CellContext(dgProfitLossAcc, new SourceGrid.Position(curRow, 4));
                Type = cellType.Value.ToString();
                ID = cellTypeID.Value.ToString();
            }
            else
            {
                SourceGrid.CellContext cellType = new SourceGrid.CellContext(dgProfitLossAcc, new SourceGrid.Position(curRow, 12));
                SourceGrid.CellContext cellTypeID = new SourceGrid.CellContext(dgProfitLossAcc, new SourceGrid.Position(curRow, 11));
                Type = cellType.Value.ToString();
                ID = cellTypeID.Value.ToString();
            ...
            if (Convert.ToInt32(ID) > 0)//Double cick event is only for either Group account or Ledger account ...not for Total amount or Opening balance
            {
                if (Type == "GROUP")// If GroupType is clicked
                {
                    ...
                    m_GBS.ProjectID = m_ProfitLoss.ProjectID;
                ...
                else if (Type == "LEDGER")//If LedgerType is clicked
                {
                    ...
                    m_TS.ProjectID = m_ProfitLoss.ProjectID;
        ...
        private void btnPrintPreview_Click_1(object sender, EventArgs e)
        {
            ...
            dtCrReport.Clear();
            dtCrReport = dtExpenditure.Clone();
            dtCrReport = dtExpenditure.Copy();
            dtCrReport.Merge(dtIncome);
            ...
            dtCrReport.Columns["EAccount"].ColumnName = "Name";
            dtCrReport.Columns["EAmount"].ColumnName = "Amount";
            dtCrReport.Columns["EType"].ColumnName = "Type";
            dtCrReport.Columns["CategoryID"].ColumnName = "GroupID";

            dtCrReport.Columns.Remove("ES.No");
            dtCrReport.Columns.Remove("EAccountID");

            dsProfitLoss.Tables["tblProfitLoss"].Merge(dtCrReport);
            //try
            //{
            //    dsProfitLoss.Tables.Remove("tblProfitLoss");
            ...
            //}
            //System.Data.DataView view = new System.Data.DataView(dtCrReport);


            //DataTable selected = view.ToTable("tblProfitLoss", false, "BalanceSheetID", "Name", "Amount", "GroupID", "Type");


            //dsProfitLoss.Tables.Add(selected);


            // DisplayVerticalProfitLoss(true);

            // var rows=dtExpenditure.AsEnumerable().Where(r=> r.Field<string>("EAccountID")=="4"&&r.Field<string>("EType")=="GROUP");
            //var rows = dtExpenditure.Rows.Cast<DataRow>().Where(r => r.Field<string>("EAccountID") == "4" && r.Field<string>("EType") == "GROUP").ToArray(); 

            //foreach(DataRow dr in rows)
            //{
            //    dtExpenditure.Rows.Remove(dr);
            //}

            //    var query = dtExpenditure.AsEnumerable().Where(r => r.Field<string>("col1") == "ali");
            //dsProfitLoss.Tables["tblProfitLoss"].row
        ...
        private void grdProfitLossAcc_Paint(object sender, PaintEventArgs e)
        {
