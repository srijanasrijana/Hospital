...
namespace Accounts
{
    public partial class frmCashFlowSettings : Form, IfrmSelectAccClassID, IfrmDateConverter
    {
        ...
        IMDIMainForm frmMDI;
        public frmCashFlowSettings(IMDIMainForm frm)
        {
            InitializeComponent();
            frmMDI = frm;
        }
        ...
        private void btnShow_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                m_CashFlow.ShowLedger = chkShowLedger.Checked;
                ...
                frmCashFlow frm = new frmCashFlow(m_CashFlow, frmMDI);
                frm.ShowDialog();
            }
            catch(Exception ex)
            {
        ...
        private void rdbtnGroupwise_CheckedChanged(object sender, EventArgs e)
        {
            rdbtnSummary.Enabled = true;
            rdbtnDetails.Enabled = true;
            chkShowLedger.Enabled = true;
            rdbtnSummary.Checked = true;
        }

        private void rdbtnAccountwise_CheckedChanged(object sender, EventArgs e)
        {
            rdbtnSummary.Enabled = false;
            rdbtnDetails.Enabled = false;
            chkShowLedger.Enabled = false;
        }
