...
namespace Accounts
{
    public partial class frmDebitNoteVoucherConfig : Form, IfrmVoucherFormat
    {
        ...
        public frmDebitNoteVoucherConfig()
        {
            m_mode = EntryMode.NEW;
            InitializeComponent();
        }

        public frmDebitNoteVoucherConfig(int SeriesID)
        {
        ...
        public frmDebitNoteVoucherConfig(Form ParentForm)
        {
            InitializeComponent();
        ...
        public frmDebitNoteVoucherConfig(int SeriesID, Form ParentForm)
        {
            m_mode = EntryMode.EDIT;
            this.SeriesID = SeriesID;
            m_ParentForm = (IfrmIsSalesConfigAdded)ParentForm;
        ...
        private void frmDebitNoteVoucherConfig_Load(object sender, EventArgs e)
        {
       if (txtFixed.Text.Length > 0 && !Misc.IsInt(txtFixed.Text, false))
                ...
                switch (m_mode)
                {
                    ...
                    case EntryMode.EDIT: //if edit button is pressed
                        ...
                        try
                        {
                            ...
                            MessageBox.Show("Debit Note Voucher Configuration Modified Successfully");
                        }
                        catch (System.Data.SqlClient.SqlException ex)
                        {
                            #region SQLExceptions
        ...
        private void frmDebitNoteVoucherConfig_KeyDown(object sender, KeyEventArgs e)
        {
