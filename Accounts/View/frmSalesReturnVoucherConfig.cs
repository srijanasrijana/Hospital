...
namespace Accounts
{
    ...
    public partial class frmSalesReturnVoucherConfig : Form, IfrmVoucherFormat
    {
        ...
        public frmSalesReturnVoucherConfig()
        {
            if(Global.salesreturn=="New")
            {
                m_mode = EntryMode.NEW;
            }
            if (Global.salesreturn == "Edit")
            {
        ...
        public frmSalesReturnVoucherConfig(Form ParentForm)
        {
            InitializeComponent();
        ...
        public frmSalesReturnVoucherConfig(int SeriesID)
        {
            m_mode = EntryMode.EDIT;
        ...
        public frmSalesReturnVoucherConfig(int SeriesID, Form ParentForm)
        {
            m_mode = EntryMode.EDIT;
            this.SeriesID = SeriesID;
            m_ParentForm = (IfrmIsSalesConfigAdded)ParentForm;
        ...
        private void frmSalesReturnVoucherConfig_Load(object sender, EventArgs e)
        {
                ...
                switch (m_mode)
                {
                    ...
                    case EntryMode.EDIT: //if edit button is pressed
                        ...
                        try
                        {
                            ...
                            MessageBox.Show("Sales Invoice Voucher Configuration Modified Successfully");
                        }
                        catch (System.Data.SqlClient.SqlException ex)
                        {
                            #region SQLExceptions
        ...
        private void frmSalesReturnVoucherConfig_KeyDown(object sender, KeyEventArgs e)
        {
