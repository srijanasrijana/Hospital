...
namespace Accounts
{
    public interface IfrmIsSalesConfigAdded 
    {
        void IsVoucherConfigAdded(bool ISVoucherConfigAdded);
    }
    public partial class frmSalesVoucherConfig : Form,IfrmVoucherFormat
    {
        ...
        public frmSalesVoucherConfig()
        {
            m_mode = EntryMode.NEW;
            InitializeComponent();
        }

        public frmSalesVoucherConfig(Form ParentForm)
        {
            InitializeComponent();
        ...
        public frmSalesVoucherConfig(int SeriesID, Form ParentForm)
        {
        ...
        private void frmSalesVoucherConfig_Load(object sender, EventArgs e)
        {
            ...
            {
                cboRenumberingFrq.SelectedIndex = 1;
            }
            #endregion
            ...
            try
            {
                ...
                switch (m_mode)
                {
                    ...
                    case EntryMode.NEW: //if new button is pressed                       
                        ...
                        try
                        {
                            #region BLOCK FOR INSERTING THE SALES VOUCHER CONFIGURATION
                            ...
                            #endregion
                            //Get The Optional Field in one object
                        ...
                        {
                            #region SWITCH FOR HANDLING EXCEPTION WHILE INSERTING SALES VOUCHER CONFIGURATION
                    ...
                    case EntryMode.EDIT: //if edit button is pressed
                        ...
                        try
                        {
                           //FUNCTION FOR VALIDATING THE DATATYPE
                            ...
                            MessageBox.Show("Sales Voucher Configuration Modified Successfully");
                        }
                        catch (System.Data.SqlClient.SqlException ex)
                        {
                            #region SQLExceptions
        ...
        private bool ValidateDataType()
        {
            ...
            if(grpEndingDetails.Enabled == true)
            {
        ...
        private void cboRenumberingFrq_SelectedIndexChanged(object sender, EventArgs e)
        {

        }

        private void frmSalesVoucherConfig_KeyDown(object sender, KeyEventArgs e)
        {
