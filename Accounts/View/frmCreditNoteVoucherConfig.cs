...
namespace Accounts
{
    public partial class frmCreditNoteVoucherConfig : Form ,IfrmVoucherFormat
    {
        ...
        public frmCreditNoteVoucherConfig()
        {
            m_mode = EntryMode.NEW;
            InitializeComponent();
        }

        public frmCreditNoteVoucherConfig(int SeriesID)
        {
        ...
        public frmCreditNoteVoucherConfig(Form ParentForm)
        {
            InitializeComponent();
        ...
        public frmCreditNoteVoucherConfig(int SeriesID, Form ParentForm)
        {
            m_mode = EntryMode.EDIT;
            this.SeriesID = SeriesID;
            m_ParentForm = (IfrmIsSalesConfigAdded)ParentForm;            
        ...
        private void frmCreditNoteVoucherConfig_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                switch (m_mode)
                {
                    ...
                    case EntryMode.NEW: //if new button is pressed                       
                        ...
                        try
                        {
                            #region BLOCK FOR INSERTING THE  DEBITNOTE VOUCHER CONFIGURATION
                    ...
                    case EntryMode.EDIT: //if edit button is pressed
                        ...
                        try
                        {
                            ...
                            MessageBox.Show("Credit Note Voucher Configuration Modified Successfully");
                        }
                        catch (System.Data.SqlClient.SqlException ex)
                        {
                            #region SQLExceptions
        ...
        private void frmCreditNoteVoucherConfig_KeyDown(object sender, KeyEventArgs e)
        {
