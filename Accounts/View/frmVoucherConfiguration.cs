...
namespace Accounts
{
    ...
    public partial class frmVoucherConfiguration : Form,IfrmIsSalesConfigAdded
    {
       ...
       //Recursive Function to Show Account Group in Treeview
        ...
        {
            bool chkUserPermission = UserPermission.ChkUserPermission("CONFIGURATION_CREATE");
            ...
            switch (tvVoucherConfiguration.SelectedNode.Tag.ToString())
            {
                ...
                case "CR_NOT":
                    ...
                    break;
                case "BRECON":
                    frmBreconVoucherConfiguration frm11 = new frmBreconVoucherConfiguration(this);
                    frm11.Show();
                    break;
                case "STOCK_TRANS":
                ...
                case "DAMAGE":
                    ...
                    break;
                case "CHEQUERCPT":
                    frmChequeReceiptVoucherConfiguration frm14 = new frmChequeReceiptVoucherConfiguration(this);
                    frm14.Show();
                    break;
            }
        }
        ...
        {
            bool chkUserPermission = UserPermission.ChkUserPermission("CONFIGURATION_MODIFY");
            if (chkUserPermission == false)
            {
            ...
            switch (dr["Voucher_Type"].ToString())
            {
                ...
                case "CR_NOT":
                    ...
                    break;
                case "BRECON":
                    frmBreconVoucherConfiguration frm11 = new frmBreconVoucherConfiguration(Convert.ToInt32(dr["SeriesID"]), this);
                    frm11.Show();
                    break;
                ...
                case "DAMAGE":
                    ...
                    break;
                case "CHEQUERCPT":
                    frmChequeReceiptVoucherConfiguration frm14 = new frmChequeReceiptVoucherConfiguration(Convert.ToInt32(dr["SeriesID"]), this);
                    frm14.Show();
                    break;
            }
        }
