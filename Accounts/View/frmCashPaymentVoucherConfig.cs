...
namespace Accounts
{
    public partial class frmCashPaymentVoucherConfig : Form, IfrmVoucherFormat
    {
        ...
        public frmCashPaymentVoucherConfig()
        {
            m_mode = EntryMode.NEW;
            InitializeComponent();
        }

        public frmCashPaymentVoucherConfig(Form ParentForm)
        {
            InitializeComponent();
        ...
        public frmCashPaymentVoucherConfig(int SeriesID)
        {
        ...
        public frmCashPaymentVoucherConfig(int SeriesID, Form ParentForm)
        {
            m_mode = EntryMode.EDIT;
            this.SeriesID = SeriesID;
            m_ParentForm = (IfrmIsSalesConfigAdded)ParentForm;
        ...
        private void frmCashPaymentVoucherConfig_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                switch (m_mode)
                {
                    ...
                    case EntryMode.NEW: //if new button is pressed                       
                        ...
                        try
                        {
                            #region BLOCK FOR INSERTING THE  CASH PAYMENT VOUCHER CONFIGURATION
                    ...
                    case EntryMode.EDIT: //if edit button is pressed
                        ...
                        try
                        {
                            ...
                            MessageBox.Show("Cash Payment Voucher Configuration Modified Successfully");
                        }
                        catch (System.Data.SqlClient.SqlException ex)
                        {
                            #region SQLExceptions
        ...
        private void frmCashPaymentVoucherConfig_KeyDown(object sender, KeyEventArgs e)
        {
