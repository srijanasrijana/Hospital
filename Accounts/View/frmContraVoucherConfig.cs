...
namespace Accounts
{
    public partial class frmContraVoucherConfig : Form, IfrmVoucherFormat
    {
        ...
        public frmContraVoucherConfig()
        {
            m_mode = EntryMode.NEW;
            InitializeComponent();
        }

        public frmContraVoucherConfig(int SeriesID)
        {
        ...
        public frmContraVoucherConfig(Form ParentForm)
        {
            InitializeComponent();
        ...
        public frmContraVoucherConfig(int SeriesID, Form ParentForm)
        {
            m_mode = EntryMode.EDIT;
            this.SeriesID = SeriesID;
            m_ParentForm = (IfrmIsSalesConfigAdded)ParentForm;
        ...
        private void frmContraVoucherConfig_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                switch (m_mode)
                {
                    ...
                    case EntryMode.NEW: //if new button is pressed                       
                        ...
                        try
                        {
                            #region BLOCK FOR INSERTING THE CONTRA VOUCHER CONFIGURATION
                    ...
                    case EntryMode.EDIT: //if edit button is pressed
                        ...
                        try
                        {
                           ...
                           m_VouConfig.Modify(SeriesID, cmbNumberingType.Text, cmbDuplicateVouNum.Text, cmbBlankVouNum.Text, txtStartingNO.Text, chkSpecifyEndNo.Checked ? true : false, txtEndingNo.Text, txtWarningVouLeft.Text, txtWarningMsg.Text, cboRenumberingFrq.Text, chkFixLength.Checked ? true : false, txtTotalLengthNumPart.Text, txtPaddingChar.Text, txtSeriesName.Text, "CNTR", VoucherFormatDtl, OF, cmbNumberingType.SelectedIndex == 0 ? chkHideVoucherNo.Checked : false);
                            MessageBox.Show("Contra Voucher Configuration Modified Successfully");
                        }
                        catch (System.Data.SqlClient.SqlException ex)
                        {
                            #region SQLExceptions
