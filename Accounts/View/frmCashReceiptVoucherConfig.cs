...
namespace Accounts
{
    public partial class frmCashReceiptVoucherConfig : Form, IfrmVoucherFormat
    {
        ...
        public frmCashReceiptVoucherConfig()
        {
            m_mode = EntryMode.NEW;
            InitializeComponent();
        }

        public frmCashReceiptVoucherConfig(int SeriesID)
        {
        ...
        public frmCashReceiptVoucherConfig(Form ParentForm)
        {
            InitializeComponent();
        ...
        public frmCashReceiptVoucherConfig(int SeriesID, Form ParentForm)
        {
            m_mode = EntryMode.EDIT;
            this.SeriesID = SeriesID;
            m_ParentForm = (IfrmIsSalesConfigAdded)ParentForm;
        ...
        private void frmCashReceiptVoucherConfig_Load(object sender, EventArgs e)
        {
                   ...
                   #region EDIT
                    case EntryMode.EDIT: //if edit button is pressed
                        try
                        {
                            ...
                            MessageBox.Show("Cash Receipt Voucher Configuration Modified Successfully");
                        }
                        catch (System.Data.SqlClient.SqlException ex)
                        {
                            #region SQLExceptions
        ...
        private void frmCashReceiptVoucherConfig_KeyDown(object sender, KeyEventArgs e)
        {
