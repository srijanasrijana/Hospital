...
namespace Accounts
{
    public partial class frmBankPaymentVoucherConfig : Form, IfrmVoucherFormat
    {
        private IfrmIsSalesConfigAdded m_ParentForm;  // this holds the datatable
        int SeriesID = 0;
        ...
        public frmBankPaymentVoucherConfig()
        {
            m_mode = EntryMode.NEW;
            InitializeComponent();
        }

        public frmBankPaymentVoucherConfig(int SeriesID)
        {
        ...
        public frmBankPaymentVoucherConfig(Form ParentForm)
        {
            InitializeComponent();
        ...
        public frmBankPaymentVoucherConfig(int SeriesID, Form ParentForm)
        {
            m_mode = EntryMode.EDIT;
            this.SeriesID = SeriesID;
            m_ParentForm = (IfrmIsSalesConfigAdded)ParentForm;            
        ...
        private void frmBankPaymentVoucherConfig_Load(object sender, EventArgs e)
        {
            ...
            if (cmbRenumberingFrq.Text == "")
            {
                cmbRenumberingFrq.SelectedIndex = 0;
            }
            #endregion
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                //Dont allow to save multiple Main Series...There is only one Main in Each voucher configuration
                ...
                if (txtSeriesName.Text.ToUpper() == "MAIN" && m_mode == EntryMode.NEW)
                {
                    ...
                    {
                        if (drSeriesInfo["EngName"].ToString().ToUpper() == txtSeriesName.Text.ToUpper())//It will consider even lower as well as upper case
                        {
                ...
                switch (m_mode)
                {
                    ...
                    case EntryMode.NEW: //if new button is pressed                    
                        try
                        {
                            #region BLOCK FOR INSERTING THE  BANK PAYMENT VOUCHER CONFIGURATION
                    ...
                    case EntryMode.EDIT: //if edit button is pressed
                        ...
                        try
                        {
                            ...
                            MessageBox.Show("Bank Payment Voucher Configuration Modified Successfully");
                        }
                        catch (System.Data.SqlClient.SqlException ex)
                        {
                            #region SQLExceptions
        ...
        private void frmBankPaymentVoucherConfig_KeyDown(object sender, KeyEventArgs e)
        {
