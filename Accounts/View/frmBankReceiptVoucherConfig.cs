...
namespace Accounts
{
    public partial class frmBankReceiptVoucherConfig : Form, IfrmVoucherFormat
    {
        ...
        public frmBankReceiptVoucherConfig()
        {
            m_mode = EntryMode.NEW;
            InitializeComponent();
        }

        public frmBankReceiptVoucherConfig(int SeriesID)
        {
        ...
        public frmBankReceiptVoucherConfig(Form ParentForm)
        {
            InitializeComponent();
        ...
        public frmBankReceiptVoucherConfig(int SeriesID, Form ParentForm)
        {
            m_mode = EntryMode.EDIT;
            this.SeriesID = SeriesID;
            m_ParentForm = (IfrmIsSalesConfigAdded)ParentForm;
        ...
        private void frmBankReceiptVoucherConfig_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                switch (m_mode)
                {
                    ...
                    case EntryMode.NEW: //if new button is pressed
                        ...
                        try
                        {
                            #region BLOCK FOR INSERTING THE  BANK RECEIPT VOUCHER CONFIGURATION
                        ...
                        {
                            #region SWITCH FOR HANDLING EXCEPTION WHILE INSERTING DEBITNOTE VOUCHER CONFIGURATION
                    ...
                    case EntryMode.EDIT: //if edit button is pressed
                        ...
                        try
                        {
                            ...
                            MessageBox.Show("Bank Receipt Voucher Configuration Modified Successfully");
                        }
                        catch (System.Data.SqlClient.SqlException ex)
                        {
                            #region SQLExceptions
                        ...
                        {
                            #region SWITCH FOR HANDLING EXCEPTION WHILE INSERTING BANK RECEIPT VOUCHER CONFIGURATION
        ...
        private void frmBankReceiptVoucherConfig_KeyDown(object sender, KeyEventArgs e)
        {
