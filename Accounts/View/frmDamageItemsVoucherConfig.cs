...
namespace Accounts
{
    public partial class frmDamageItemsVoucherConfig : Form, IfrmVoucherFormat
    {
        ...
        public frmDamageItemsVoucherConfig()
        {
            m_mode = EntryMode.NEW;
            InitializeComponent();
        }
        public frmDamageItemsVoucherConfig(IMDIMainForm frm)
        {
            InitializeComponent();
            m_MDIForm = frm;
            
        }
        public frmDamageItemsVoucherConfig(int SeriesID)
        {
            m_mode = EntryMode.EDIT;
            this.SeriesID = SeriesID;
            InitializeComponent();
        }
         public frmDamageItemsVoucherConfig(Form ParentForm)
        {
            InitializeComponent();
         ...
         public frmDamageItemsVoucherConfig(int SeriesID, Form ParentForm)
        {
            m_mode = EntryMode.EDIT;
            this.SeriesID = SeriesID; 
            m_ParentForm = (IfrmIsSalesConfigAdded)ParentForm;
        ...
        private void frmDamageItemsVoucherConfig_Load(object sender, EventArgs e)
        {
                ...
                switch (m_mode)
                {
                    ...
                    case EntryMode.EDIT: //if edit button is pressed
                        try
                        {
                            ...
                            MessageBox.Show("Damage Items Voucher Configuration Modified Successfully");
                        }
                        catch (System.Data.SqlClient.SqlException ex)
                        {
                            #region SQLExceptions
        ...
        private void btnNumberingFormat_Click(object sender, EventArgs e)
        {
            if (SeriesID > 0)//edit mode
            {
                ...
                frm.Show();
               // m_MDIForm.OpenForm("frmVoucherFormat");
            }
            else //new mode
            {
