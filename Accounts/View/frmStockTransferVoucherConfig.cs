...
namespace Accounts
{
    public partial class frmStockTransferVoucherConfig : Form, IfrmVoucherFormat
    {
        ...
        public frmStockTransferVoucherConfig()
        {
            m_mode = EntryMode.NEW;
            InitializeComponent();
        }

        public frmStockTransferVoucherConfig(int SeriesID)
        {
        ...
        public frmStockTransferVoucherConfig(Form ParentForm)
        {
            InitializeComponent();
        ...
        public frmStockTransferVoucherConfig(int SeriesID, Form ParentForm)
        {
            m_mode = EntryMode.EDIT;
            this.SeriesID = SeriesID;
            m_ParentForm = (IfrmIsSalesConfigAdded)ParentForm;
        ...
        private void frmStockTransferVoucherConfig_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                switch (m_mode)
                {
                    ...
                    case EntryMode.NEW: //if new button is pressed                       
                        ...
                        try
                        {
                            #region BLOCK FOR INSERTING THE Stock Transfer VOUCHER CONFIGURATION
                    ...
                    case EntryMode.EDIT: //if edit button is pressed
                        ...
                        try
                        {
                            ...
                            MessageBox.Show("Stock Transfer Voucher Configuration Modified Successfully");
                        }
                        catch (System.Data.SqlClient.SqlException ex)
                        {
                            #region SQLExceptions
        ...
        private void frmContraVoucherConfig_KeyDown(object sender, KeyEventArgs e)
        {
