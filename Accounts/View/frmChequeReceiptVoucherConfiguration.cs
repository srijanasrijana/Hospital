...
namespace Accounts
{
    public partial class frmChequeReceiptVoucherConfiguration : Form, IfrmVoucherFormat
    {
        ...
        public frmChequeReceiptVoucherConfiguration()
        {
            m_mode = EntryMode.NEW;
            InitializeComponent();
        }
        public frmChequeReceiptVoucherConfiguration(int SeriesID)
        {
             m_mode = EntryMode.EDIT;
            this.SeriesID = SeriesID;
            InitializeComponent();
        }
        public frmChequeReceiptVoucherConfiguration(Form ParentForm)
        {
            InitializeComponent();
             m_ParentForm = (IfrmIsSalesConfigAdded)ParentForm;
            m_mode = EntryMode.NEW;
        }
        public frmChequeReceiptVoucherConfiguration(int SeriesID, Form ParentForm)
        {
            InitializeComponent();
             m_mode = EntryMode.EDIT;
            this.SeriesID = SeriesID; 
        ...
        private void frmChequeReceiptVoucherConfiguration_Load(object sender, EventArgs e)
        {
                ...
                switch (m_mode)
                {
                    ...
                    case EntryMode.EDIT: //if edit button is pressed
                        try
                        {
                            ...
                            MessageBox.Show("Cheque Receipt Voucher Configuration Modified Successfully");
                        }
                        catch (System.Data.SqlClient.SqlException ex)
                        {
                            #region SQLExceptions
