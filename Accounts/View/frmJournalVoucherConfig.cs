...
namespace Accounts
{
    public partial class frmJournalVoucherConfig : Form,IfrmVoucherFormat
    {
        private IfrmIsSalesConfigAdded m_ParentForm; //this holds the datatables
        int SeriesID = 0;
        ...
        public frmJournalVoucherConfig()
        {
            m_mode = EntryMode.NEW;
            InitializeComponent();
        }

        public frmJournalVoucherConfig(int SeriesID)
        {
        ...
        public frmJournalVoucherConfig(Form ParentForm)
        {
            InitializeComponent();
        ...
        public frmJournalVoucherConfig(int SeriesID, Form ParentForm)
        {
            m_mode = EntryMode.EDIT;
            this.SeriesID = SeriesID;
            m_ParentForm = (IfrmIsSalesConfigAdded)ParentForm;
        ...
        private void frmJournalVoucherConfig_Load(object sender, EventArgs e)
        {                 
            if (txtFixed.Text.Length > 0 && !Misc.IsInt(txtFixed.Text, false))
            {
                MessageBox.Show("The fixed field is not numeric");
                return;
            }
            ...
            chkHideVoucherNo.Checked = false;
          ...
          #region FILL THIS FORM IN THE RESPECTIVE FIELDS IF EDIT BUTTON  IS CLICKED
                ...
                try
                {
                   ...
                   if (drVouNumConfig["HideVouNum"].ToString() == "True")
                   {
                       chkHideVoucherNo.Checked = true;
                   }
                   else
                   {
                       chkHideVoucherNo.Checked = false;
                   ...
                   cmbRenumberingFrq.Text = drVouNumConfig["RenumberingFrq"].ToString();
        ...
        {           
            try
            {
                ...
                {
                    //txtEndingNo.Text="10000";
                    //txtWarningVouLeft.Text = "999";
                }
                ...
                switch (m_mode)
                {
                    ...
                    case EntryMode.NEW: //if new button is pressed                                                
                        ...
                        try
                        {
                            #region BLOCK FOR INSERTING THE  JORNAL VOUCHER CONFIGURATION
                            ...
                            m_VouConfig.Insert(cmbNumberingType.Text, cmbDuplicateVouNum.Text, cmbBlankVouNum.Text, txtStartingNO.Text, chkSpecifyEndNo.Checked ? true : false, txtEndingNo.Text, txtWarningVouLeft.Text, txtWarningMsg.Text, cmbRenumberingFrq.Text, chkFixLength.Checked ? true : false, txtTotalLengthNumPart.Text, txtPaddingChar.Text, txtSeriesName.Text, "JNL", VoucherFormatDtl,OF,cmbNumberingType.SelectedIndex == 0? chkHideVoucherNo.Checked : false);
                            MessageBox.Show("Journal Voucher Configuration Saved Successfully");
#endregion
                        }
                        ...
                        {
       #region SWITCH FOR HANDLING EXCEPTION WHILE INSERTING JOURNAL VOUCHER CONFIGURATION
                    ...
                    case EntryMode.EDIT: //if edit button is pressed
                        ...
                        try
                        {
                            ...
                            MessageBox.Show("Journal Voucher Configuration Modified Successfully");
        ...
        private void cmbNumberingType_SelectedIndexChanged_1(object sender, EventArgs e)
        {
        ...
        private void chkSpecifyEndNo_CheckedChanged_1(object sender, EventArgs e)
        {
        ...
        private void chkFixLength_CheckedChanged_1(object sender, EventArgs e)
        {
        ...
        private void frmJournalVoucherConfig_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void chkHideVoucherNo_CheckedChanged(object sender, EventArgs e)
        {
            if (chkHideVoucherNo.Checked)
            {
                lblHideVocherNo.Text = "Voucher number increases after saving.";
            }
            else
            {
                lblHideVocherNo.Text = "";
            }

        }

        private void grpAutoNumbering_Enter(object sender, EventArgs e)
        {
