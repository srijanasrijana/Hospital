...
namespace Accounts
{
    public partial class frmBreconVoucherConfiguration : Form, IfrmVoucherFormat
    {
        ...
        public frmBreconVoucherConfiguration()
        {
            m_mode = EntryMode.NEW;
            InitializeComponent();
        }
        public frmBreconVoucherConfiguration(int SeriesID)
        {
            m_mode = EntryMode.EDIT;
            this.SeriesID = SeriesID;
            InitializeComponent();
        }
         public frmBreconVoucherConfiguration(Form ParentForm)
        {
            InitializeComponent();
         ...
         public frmBreconVoucherConfiguration(int SeriesID, Form ParentForm)
        {
            m_mode = EntryMode.EDIT;
            this.SeriesID = SeriesID; 
            m_ParentForm = (IfrmIsSalesConfigAdded)ParentForm;
        ...
        private void frmBreconVoucherConfiguration_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                switch (m_mode)
                {
                    ...
                    case EntryMode.NEW: //if new button is pressed
                        ...
                        try
                        {
                            #region BLOCK FOR INSERTING THE  CASH RECEIPT VOUCHER CONFIGURATION
                    ...
                    case EntryMode.EDIT: //if edit button is pressed
                        try
                        {
                            ...
                            MessageBox.Show("Bank Reconciliation Voucher Configuration Modified Successfully");
                        }
                        catch (System.Data.SqlClient.SqlException ex)
                        {
                            #region SQLExceptions
        ...
        private void frmBreconVoucherConfiguration_KeyDown(object sender, KeyEventArgs e)
        {
