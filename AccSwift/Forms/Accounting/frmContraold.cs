...
namespace AccSwift
{
    public partial class frmContra : Form, IfrmAddAccClass, IfrmDateConverter
    {
        ...
        private void AddGridHeader()
        {
            ...
            grdContra[0, 6] = new SourceGrid.Cells.ColumnHeader("Remarks");
            grdContra[0, 7] = new SourceGrid.Cells.ColumnHeader("Ledger ID");
            grdContra[0, 8] = new SourceGrid.Cells.ColumnHeader("Current Balance");
        ...
        private void AddRowContra(int RowCount)
        {
            ...
            grdContra[i, 5] = new SourceGrid.Cells.Cell("", txtRemarks);
            grdContra[i, 5].Value = "(NEW)";
