...
namespace Inventory
{
    public partial class frmProject : Form
    {
        ...
        {
            bool chkUserPermission = UserPermission.ChkUserPermission("PROJECT_CREATE_MODIFY");
            ...
            switch (m_mode)
            {
                ...
                case EntryMode.EDIT:
                    ...
                    {
                        Global.Msg("The parent Project name selected is the child of its own Project");
                        return;
                    }
        ...
        private void ClearProjectHeadForm()
        {
            ...
            cboParentProjectName.Text = string.Empty;
        }
