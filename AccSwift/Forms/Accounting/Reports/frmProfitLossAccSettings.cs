...
namespace Inventory
{
    public partial class frmProfitLossAccSettings : Form,IfrmSelectAccClassID, IfrmDateConverter
    {
        ...
        private void btnShow_Click(object sender, EventArgs e)
        {
            ...
            frmProfitLossAcc frmShow = new frmProfitLossAcc(m_ProfitLoss);//Passing object as an argument 
            frmShow.ShowDialog();
        }
        ...
        private string ChangeReportPreferences()
        {
            ...
            //UserID = User.CurrUserID;
            //DataTable dt = m_ReportPreference.GetPreferenceInfo(UserID, "PROFIT_LOSS");
            //if (chkDate.Checked)
            //{
            //    Code = "PL_DATE";
            //    Value = "1";
