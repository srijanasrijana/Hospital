...
namespace Inventory
{
    public partial class frmVATReport : Form
    {
        ...
        private DataSet.dsVATReport dsVatReport1 = new DataSet.dsVATReport();
        ...
        {
            //Define Header Part
            grdVATReport[0, 0] = new SourceGrid.Cells.ColumnHeader("Net Amount");
        ...
        {
            //Define Header Part
            grdvatpaid[0, 0] = new SourceGrid.Cells.ColumnHeader("Net Amount");
           ...
           // string AccClassIDsXMLString = ReadAllAccClassID();
            ...
            if (m_VATReport.Summary == true)
            {
               ...
               // MessageBox.Show(test.ToString());
                ...
                DataTable dtTransactInfo = m_TransactInfo.GetLedgerTransactWithAccClassAndProjectID("412", TotalAccClassIDs, ProjectIDS);
        ...
        private void PrintPreviewCR(PrintType myPrintType)
        {
            ...
            dsVatReport1.Clear();
            CrystalReports.rptVATReport rpt = new CrystalReports.rptVATReport();
